...
fn self_test() {
    ...
    let ikm_r = Bytes::from_hex("93c7c22beb0f44ae5582c9197f4d7ec3");
    let rand_s = Bytes::from_hex("53dd33701a0486b1a3630e82b20eabf9");
    ...
    assert_eq!(zz_r.into_native(), zz_s.into_native());
}
